...
export default async function ChatbotPage({ params }: ChatbotSettingsProps) {
    ...
    return (
        <DashboardShell>
            <DashboardHeader heading="Чатбот" text="Настройка вашего чатбота здесь">
                <Link
            ...
            <Tabs className="w-full" defaultValue="settings">
                <TabsList className="mb-5 grid w-full grid-cols-5 gap-4">
                    <TabsTrigger value="settings">Основные настройки</TabsTrigger>
                    <TabsTrigger value="advancedSettings">Расширенные настройки</TabsTrigger>
                    <TabsTrigger value="customizations">Кастомизации</TabsTrigger>
                    <TabsTrigger value="inquiry">Форма заявки</TabsTrigger>
                    <TabsTrigger value="pro">Функции PRO 👑</TabsTrigger>
                </TabsList>
                    ...
                    <div className="space-y-4">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Это уникальный идентификатор чатбота, созданный {siteConfig.name}.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
